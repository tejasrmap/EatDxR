...
export function AppStoriesBar({ onLogClick }: AppStoriesBarProps) {
  ...
  return (
    <div className="w-full overflow-x-auto scrollbar-hide py-3 px-3 sm:px-4 rounded-2xl sm:rounded-3xl border border-slate-200/80 dark:border-white/10 bg-white dark:bg-zinc-950/70 backdrop-blur-md shadow-sm dark:shadow-xl mb-3 sm:mb-4 snap-x snap-mandatory">
      <div className="flex items-center gap-3.5 sm:gap-4 w-max">
        ...
        >
          <div className="relative w-15 h-15 sm:w-16 sm:h-16 rounded-full p-0.5 border-2 border-dashed border-orange-500/70 flex items-center justify-center bg-orange-50/60 dark:bg-zinc-900 group-hover:border-orange-400 group-hover:shadow-[0_0_15px_rgba(249,115,22,0.3)] transition-all">
            <div className="w-full h-full rounded-full bg-orange-100/70 dark:bg-zinc-850 flex items-center justify-center text-orange-500 dark:text-orange-400 group-hover:scale-105 transition-transform">
              <Plus size={22} className="text-orange-500 dark:text-orange-400" />
            </div>
            <div className="absolute -bottom-0.5 -right-0.5 w-4.5 h-4.5 rounded-full bg-gradient-to-r from-orange-500 to-amber-500 text-white dark:text-black flex items-center justify-center font-black text-[11px] shadow-md border-2 border-white dark:border-black">
              +
            </div>
          </div>
          <span className="text-[10px] font-semibold text-slate-700 dark:text-white/80 max-w-[60px] sm:max-w-[66px] truncate group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors">
            Post Craving
          </span>
        </motion.button>
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className="text-[10px] font-medium text-slate-700 dark:text-white/80 max-w-[60px] sm:max-w-[66px] truncate group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors">
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className="text-[10px] font-medium text-slate-700 dark:text-white/80 max-w-[60px] sm:max-w-[66px] truncate group-hover:text-purple-600 dark:group-hover:text-purple-300 transition-colors">
